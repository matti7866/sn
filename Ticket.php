    ...
    <div class="panel-body p-3">
        ...
        <form method="post" enctype="multipart/form-data" id="addTicket">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3">
                  <span class="form-label col-form-label text-inverse"><i class="fa fa-user"></i> Customer Name:</span>  
                  <select class="col-sm-4 form-control js-example-basic-single"  onchange="getPayments()"  style="width:100%" id="cust_name" name="cust_name" spry:default="select one"></select>
                </div>
                <div class="col-lg-2 d-none" id="duePaymentDiv">
                    <div class="btn-group">
                        <button type="button" class="btn btn-danger   mt-3 dropdown-toggle"  data-bs-toggle="dropdown" aria-expanded="false">
                            Total Pending Payments <i class="fa fa-caret-down" aria-hidden="true"></i>
                        </button>
                        
                        <ul class="dropdown-menu" id="total_charge">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <span class="form-label col-form-label text-inverse"><i class="fa fa-i"></i> Remakrs :</span> 
                    <textarea class="form-control" placeholder="Write remarks here" id="remarks" name="remarks" rows="1"></textarea>
                </div>
            ...
            <hr style="color:black">
            <h2 class="text-dark text-center"><i class="fa fa-file text-dark"></i> Today's Ticket Report</h2>
            <hr style="color:black">
            ...
            success: function (response) {  
                ...
                if(todaysTicketRpt.length > 0){
                    for(var i=0; i<todaysTicketRpt.length; i++){
                        ...
                        todaysTicketRpt[i].ticketNumber + '</td><td>' + todaysTicketRpt[i].depature + '</td><td>' + 
                        todaysTicketRpt[i].arrival + '</td><td>' + todaysTicketRpt[i].dateofTravel + '</td><td>' + 
                    ...
                    $('#ticketRptTblBody').append("<tr><td></td><td></td><td></td><td></td><td></td><td><h5>No Data Entered!</h5></td><td></td><td></td><td></td><td></td><td></td></tr>");
                }
            },
        });
    }
