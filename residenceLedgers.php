                                ...
                                <table id="myTable" class="table  table-striped table-hover table-bordered ">
                                    <thead>
                                        <tr id="ad" class="bg-danger text-white">
                                            ...
                                            <th style="-webkit-print-color-adjust: exact;">Customer Name</th>
...
<script>
    ...
    function getTicketReport() {
        ...
        $.ajax({
            type: "POST",
            url: "residenceLedgersController.php",
            data: {
            ...
            success: function(response) {
                ...
                for (var i = 0; i < report.length; i++) {
                    ...
                    finalTable = "<tr><td scope='row' style='-webkit-print-color-adjust: exact;'>" + j + "</td>" +
                        "<td class='text-capitalize' colspan='1' style='-webkit-print-color-adjust: exact;'>" + report[i].customer_name + "</td>" +
