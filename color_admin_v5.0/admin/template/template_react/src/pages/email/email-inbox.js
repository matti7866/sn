			...
			<div className="mailbox">
				<div className="mailbox-sidebar">
					<div className="mailbox-sidebar-header d-flex justify-content-center">
						<button onClick={this.toggleMobileEmailNav} className="btn btn-inverse btn-sm me-auto d-block d-lg-none">
							<i className="fa fa-cog"></i>
						</button>
						<Link to="/email/compose" className="btn btn-inverse ps-40px pe-40px btn-sm">
							Compose
						</Link>
					</div>
					<div className={'mailbox-sidebar-content collapse d-lg-block ' + (this.state.isMobileEmailNavOn ? 'show' : '') }>
						<PerfectScrollbar className="h-100" options={{suppressScrollX: true}}>
							...
							<ul className="nav nav-inbox">
								<li><Link to="/email/inbox"><i className="fa fa-fw fa-lg fs-12px me-2 fa-circle text-inverse"></i> Admin</Link></li>
				...
				<div className="mailbox-content">
					<div className="mailbox-content-header">
						<div className="btn-toolbar align-items-center">
							<div className="form-check me-2">
								<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailSelectAll" data-change="email-select-all" />
							...
							<div className="dropdown me-2">
								<Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggle}>
									...
									<DropdownMenu>
										...
										<DropdownItem><i className="fa fa-circle fs-9px fa-fw me-2 text-muted"></i> Unread</DropdownItem>
										<DropdownItem><i className="fa fa-circle fs-9px fa-fw me-2 text-blue"></i> Contacts</DropdownItem>
										<DropdownItem><i className="fa fa-circle fs-9px fa-fw me-2 text-success"></i> Groups</DropdownItem>
										<DropdownItem><i className="fa fa-circle fs-9px fa-fw me-2 text-warning"></i> Newsletters</DropdownItem>
										<DropdownItem><i className="fa fa-circle fs-9px fa-fw me-2 text-danger"></i> Social updates</DropdownItem>
										<DropdownItem><i className="fa fa-circle fs-9px fa-fw me-2 text-indigo"></i> Everything else</DropdownItem>
									</DropdownMenu>
								</Dropdown>
							</div>
						...
						<PerfectScrollbar className="h-100" options={{suppressScrollX: true}}>
							<ul className="list-group list-group-lg no-radius list-email">
								<li className="list-group-item unread">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox1" />
								...
								<li className="list-group-item unread">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox2" />
								...
								<li className="list-group-item unread">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox3" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox4" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox5" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox6" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox7" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox8" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox9" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox10" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox11" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox12" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox13" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox14" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox15" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox16" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox17" />
								...
								<li className="list-group-item">
									<div className="email-checkbox">
										<div className="form-check">
											<input onChange={this.handleOnChange} type="checkbox" className="form-check-input" data-checked="email-checkbox" id="emailCheckbox18" />
					...
					<div className="mailbox-content-footer d-flex align-items-center">
						<div className="text-inverse fw-bold">1,232 messages</div>
						<div className="btn-group ms-auto">
							<button className="btn btn-white btn-sm">
