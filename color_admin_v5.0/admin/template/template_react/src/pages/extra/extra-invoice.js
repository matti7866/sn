				...
				<div className="invoice">
					<div className="invoice-company">
						<span className="float-end hidden-print">
							...
							<Link to="/extra/invoice" className="btn btn-sm btn-white mb-10px"><i className="fa fa-print t-plus-1 fa-fw fa-lg"></i> Print</Link>
						</span>
						Company Name, Inc
					</div>
					<div className="invoice-header">
						...
						<div className="invoice-date">
							...
							<div className="date text-inverse mt-5px">August 3,2021</div>
