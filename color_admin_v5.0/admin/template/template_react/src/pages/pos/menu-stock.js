														...
														<div className="product-option">
															<div className="option">
																...
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="20" />
																</div>
															</div>
															<div className="option">
																...
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product1" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="30" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product2" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="15" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product3" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="10" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product4" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															...
															<div className="option">
																...
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product5" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="0" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product6" value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="50" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product7" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															...
															<div className="option">
																...
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product8" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="13" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product9" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															...
															<div className="option">
																...
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product10" checked value="1" />
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="32" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product11" checked value="1" />
																		<label className="form-check-label" htmlFor="product11"></label>
																	</div>
																</div>
															</div>
														</div>
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="7" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product12" checked value="1" />
																		<label className="form-check-label" htmlFor="product12"></label>
																	</div>
																</div>
															</div>
														</div>
													...
													<div className="product-info">
														...
														<div className="product-option">
															...
															<div className="option">
																...
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product13" checked value="1" />
																		<label className="form-check-label" htmlFor="product13"></label>
																	</div>
																</div>
															</div>
														</div>
													...
													<div className="product-info">
														...
														<div className="product-option">
															...
															<div className="option">
																...
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product14" checked value="1" />
																		<label className="form-check-label" htmlFor="product14"></label>
																	</div>
																</div>
															</div>
														</div>
													...
													<div className="product-info">
														...
														<div className="product-option">
															...
															<div className="option">
																...
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product15" checked value="1" />
																		<label className="form-check-label" htmlFor="product15"></label>
																	</div>
																</div>
															</div>
														</div>
													...
													<div className="product-info">
														...
														<div className="product-option">
															<div className="option">
																<div className="option-label">Stock:</div>
																<div className="option-input">
																	<input type="text" onChange={this.handleChange} className="form-control" value="16" />
																</div>
															</div>
															<div className="option">
																<div className="option-label">Availability:</div>
																<div className="option-input">
																	<div className="form-switch">
																		<input type="radio" onChange={this.handleChange} className="form-check-input" name="" id="product16" checked value="1" />
																		<label className="form-check-label" htmlFor="product16"></label>
																	</div>
																</div>
															</div>
														</div>
