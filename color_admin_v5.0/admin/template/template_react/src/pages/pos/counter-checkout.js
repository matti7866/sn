	...
	render() {
		return (
			<div className="vh-100">
				<div className={'pos pos-counter ' + (this.state.posMobileSidebarToggled ? 'pos-mobile-sidebar-toggled' : '')} id="pos-counter">
							...
							<PerfectScrollbar className="pos-counter-content-container">
								<div className="table-row">
									<div className="table in-use selected">
										<Link to="/pos/counter-checkout" className="table-container" onClick={() => this.togglePosMobileSidebar()}>
