						...
						<div class="form-group row">
							...
							<div class="col-lg-8">
								<div class="input-group">
									...
									<button class="btn btn-inverse" type="button" data-toggle="clipboard" data-clipboard-target="#clipboard-default"><i class="fa fa-clipboard"></i></button>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-lg-8">
								...
								<button class="btn btn-inverse btn-sm" type="button" data-toggle="clipboard" data-clipboard-target="#clipboard-textarea" data-clipboard-action="cut">Cut to clipboard</button>
							</div>
						</div>
						<div class="form-group row">
							<label class="form-label col-form-label col-lg-4">without Form</label>
							<div class="col-lg-8">
								<button class="btn btn-inverse btn-sm" type="button" data-toggle="clipboard" data-clipboard-text="Just because you can doesn't mean you should — clipboard.js">Click to copy</button>
							</div>
						</div>
					</form>
				</div>
