		...
		<div class="pos-counter-body">
			...
			<div class="pos-counter-sidebar" id="pos-counter-sidebar">
				...
				<div class="pos-sidebar-footer">
					...
					<div class="btn-row">
						<a href="#" class="btn btn-default w-150px"><i class="fa fa-qrcode fa-fw fa-lg"></i> Digital Wallet</a>
						<a href="#" class="btn btn-default w-150px"><i class="fab fa-cc-visa fa-fw fa-lg"></i> Credit Card</a>
