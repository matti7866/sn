			...
			<div class="panel panel-inverse" data-sortable-id="ui-widget-8">
				...
				<div class="panel-body">
					<div data-scrollbar="true" data-height="280px">
						<p>
							<span class="fa-stack fa-4x float-start me-10px text-inverse">
						...
						<p>
							<span class="fa-stack fa-4x float-end ms-10px text-inverse">
...
&lt;/div&gt;</code></pre>
			...
			<div class="panel panel-inverse" data-sortable-id="ui-widget-9">
				...
				<textarea class="form-control no-rounded-pill border-1 border-start-0 border-end-0 border-bottom-0 rounded-0 bg-gray-100" rows="5">This is a form textarea.</textarea>
  ...
  &lt;div class="panel-toolbar"&gt;
    ...
    &lt;/div&gt;
  &lt;/div&gt;
  &lt;textarea class="form-control no-rounded-pill border-1 border-start-0 border-end-0 border-bottom-0 rounded-0 bg-gray-100" rows="5"&gt;...&lt;/textarea&gt;
  &lt;div class="panel-footer text-end"&gt;
